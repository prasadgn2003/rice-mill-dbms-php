...
<body>
    <div class="outer">
        <div class="inner">
            ...
            <div class="user">
                <h2><center class="sign-up">Rice Entry</center></h2>
                <form class="form-element" action="rice_process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input  id="name" type="name" name="rice_name"placeholder="Rice Name" required> 
